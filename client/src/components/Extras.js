                ...
                <form onSubmit={this.formSubmit}>
                    <div className="row col-lg-10 mx-auto">
                        ...
                        <div className="col-lg-6 md-form">
                            ...
                            <label htmlFor="extra_1">Languages<span style={{color: 'red'}}>*</span></label>
                        </div>
                        <div className="col-lg-6 md-form">
                            ...
                            <label htmlFor="extra_2">Hobbies<span style={{color: 'red'}}>*</span></label>
                        </div>
                    </div>
                    <br />
                    <div className="row col-lg-10 mx-auto">
                        ...
                        <div className="col-lg-6 md-form">
                            ...
                            <label htmlFor="extra_3">Activity/Achievement<span style={{color: 'red'}}>*</span></label>
                        </div>
                        <div className="col-lg-6 md-form">
                            ...
                            <label htmlFor="extra_4">Activity/Achievement<span style={{color: 'red'}}>*</span></label>
                        </div>
                    </div>
                    ...
                    <div className="row col-lg-10 mx-auto">
                        <div className="col-lg-12 md-form">
                            ...
                            <label htmlFor="extra_5">Activity/Achievement<span style={{color: 'red'}}>*</span></label>
                        </div>
                    </div>
                    <br />
